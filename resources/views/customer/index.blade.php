    ...
    <template id="template_card">
        <div class="d-flex align-items-center mb-7">
            ...
            <div class="flex-grow-1 d-flex justify-content-between">
                <div>
                    <p href="#" class="text-gray-900 fw-bold text-hover-primary fs-6 text-uppercase account_name"></p>
...
@section('script')
    ...
    <script src="assets/js/customer/add.js"></script>
    <script src="assets/js/customer/add_card.js"></script>
@endsection
