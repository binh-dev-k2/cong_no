        ...
        <div class="card">
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    <div class="d-flex justify-content-end" data-kt-debit-table-toolbar="base">
                    ...
                    <div class="d-flex justify-content-end align-items-center d-none"
                         data-kt-debit-table-toolbar="selected">
                        <div class="fw-bold me-5">
                            <span class="me-2" data-kt-debit-table-select="selected_count"></span>Hàng được chọn
                        </div>
                        <button type="button" class="btn btn-danger"
                                data-kt-debit-table-select="delete_selected">Xóa</button>
                    </div>
                </div>
            </div>
                        ...
                        <th class="w-10px pe-2">
                            <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                <input class="form-check-input" type="checkbox" data-kt-check="true"
                                       data-kt-check-target="#kt_debits_table .form-check-input" value="1" />
                            </div>
                        </th>
