        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper">
            <div id="kt_app_sidebar_menu_scroll" class="scroll-y my-5 mx-3" data-kt-scroll="true"
                ...
                <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6" id="#kt_app_sidebar_menu"
                    ...
                    <div class="menu-item">
                        <a class="menu-link  <?php if(Route::currentRouteName() == 'dashboard'): ?> active <?php endif; ?>"
                    ...
                    <div class="menu-item">
                        <a class="menu-link <?php if(Route::currentRouteName() == 'customer'): ?> active <?php endif; ?>"
                    ...
                    <div class="menu-item">
                        <a class="menu-link <?php if(Route::currentRouteName() == 'business'): ?> active <?php endif; ?>"
                            href="<?php echo e(route('business')); ?>">
                            <span class="menu-icon">
                    ...
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link <?php if(Route::currentRouteName() == 'debit'): ?> active <?php endif; ?>"
                            href="<?php echo e(route('debit')); ?>">
                            <span class="menu-icon">
                    ...
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link <?php if(Route::currentRouteName() == 'user'): ?> active <?php endif; ?>" href="<?php echo e(route('user')); ?>">
                            <span class="menu-icon">
